...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <rules>
        ...
        <description>--DEPRECATED--Sets standard Record Type to Costs if Record Type is Costs</description>
    ...
    <rules>
        ...
        <description>--DEPRECATED--Sets standard Record Type to Costs if field Record Type is Costs</description>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        ...
        <description>--DEPRECATED-- Sets standard Record Type to Fees if Record Type is Fees</description>
        <triggerType>onAllChanges</triggerType>
    </rules>
</Workflow>
